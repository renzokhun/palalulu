    ...
    <div className='home'>
      ...
      <div className='home-introduction-wrapper'>
        ...
        <div className='home-introduction'>
          ...
          With a <span>strong dedication to continuous learning</span>, I constantly pursue new challenges and chances for personal growth.<br /><br />
